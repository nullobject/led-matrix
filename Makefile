...
$(BUILD_DIR)/$(PROJECT).ngc: button_driver.vhd clock_generator.vhd config.vhd debounce.vhd display.vhd gamma.vhd memory.vhd spi_slave.vhd top.vhd $(PROJECT).prj | $(BUILD_DIR)
	@cd $(BUILD_DIR); \
